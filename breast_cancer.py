...
def predict():
    ...
    if request.method == "POST":
        ...
        if output==0:
            return render_template('breast_cancer.html',prediction_text="patient has cancer(malignat tumer){}".format(output))
        else:
            return render_template('breast_cancer.html',prediction_text="patient has no cancer(malignat benigh){}".format(output))
